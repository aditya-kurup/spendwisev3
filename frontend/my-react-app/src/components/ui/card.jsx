...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-2xl font-semibold leading-none tracking-tight after:content-[''] after:absolute after:left-6 after:right-6 after:bottom-0 after:h-[2px] after:bg-gradient-to-r after:from-primary/70 after:to-transparent", 
      className
    )}
    {...props}
  />
